...
num_linhas = 1000
# Cabeçalho do CSV
cabecalho = ['id_colaborador', 'nome_colaborador', 'departamento', 'motivo_ausencia', 'horas_ausencia', 'data_ausencia', 'salario']
...
for i in range(49):
    ...
    with open(nome_arquivo, 'w', newline='', encoding='utf-8') as arquivo_csv:
        ...
        for _ in range(num_linhas):
            ...
            departamento = fake.random_element(elements=('TI', 'Recursos Humanos', 'Vendas', 'Marketing'))
            motivo_ausencia = fake.random_element(elements=('Doença', 'Férias', 'Licença Médica', 'Problemas Pessoais', 'Viagem de Negocio', 'Outros'))
            ...
            escritor_csv.writerow([id_colaborador, nome_colaborador, departamento, motivo_ausencia, horas_ausencia, data_ausencia, salario])
